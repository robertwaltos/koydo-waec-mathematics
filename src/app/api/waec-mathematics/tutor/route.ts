...
const EXAM_ID = "waec-mathematics";
const EXAM_DISPLAY_NAME = "WAEC Mathematics";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover WAEC Mathematics: Number & Numeration, Algebraic Processes, Geometry & Trigonometry, Statistics & Probability, and Vectors & Transformations. Align to WAEC Mathematics syllabus.
