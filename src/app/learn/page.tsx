...
export const metadata: Metadata = {
  title: "Learn — WAEC Mathematics Practice",
  description: "Study and practice for WAEC Mathematics. Choose your subject and start preparing.",
};
