...
export const metadata: Metadata = {
  title: "Pricing — Waec Mathematics Premium",
  description: "Unlock unlimited Waec Mathematics practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=waec-mathematics&cadence=annual`;
